...
public class SmartMeterDataDTO {
    ...
    public static SmartMeterDataDTO createSmartMeterDataDTO(MeterDataReading smartMeterData) {
        return new SmartMeterDataDTO(smartMeterData.time, smartMeterData.sensorId,
